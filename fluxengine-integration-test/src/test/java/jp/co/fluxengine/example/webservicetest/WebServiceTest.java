...
public class WebServiceTest extends PersisterExtractor {
    ...
    void testWebService() throws Exception {
        ...
        // persisterの現在の値を取得する
        double usageBefore = currentPacketUsage("webservice", "webservice/パケット積算#Webserviceパケット積算データ");
        ...
        // 実行後のパケット積算量を取得する
        double usageAfter = currentPacketUsage("webservice", "webservice/パケット積算#Webserviceパケット積算データ");
